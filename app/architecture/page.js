...
const TECH_STACK_ROW_2 = [
  {
    ...
    cost: "$0",
    desc: "Leverages Performance Timing API for Web Vitals speed analytics, CompressionStream for stateless URLs, PDF.js for document parsing, and SessionStorage for state.",
    icon: (
      <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    cost: "$0",
    desc: "Cloud PostgreSQL database hosting. Holds visitor telemetry, page views, and performance logs in complete isolation.",
    icon: (
      <svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" style={{ color: '#3ecf8e' }}>
        <path d="M13.92 2L5 12.86h6.92L10.08 22 19 11.14h-6.92z"/>
      </svg>
